...
class AIClient:
    ...
    def generate_commit_message(self, diff_text: str, context: Optional[Dict[str, Any]] = None) -> str:
        """
            ...
            try:
                ...
                response = self._client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "You are a helpful assistant that generates clear and concise git commit messages following conventional commit format. Always wrap your response in triple backticks."
                        },
                        {
                            "role": "user",
                            "content": prompt
